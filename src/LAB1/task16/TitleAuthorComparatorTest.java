...
class TitleAuthorComparatorTest {
    ...
    void compare() {
        ...
        assertTrue(titleAuthorComparator.compare(book1, book2) < 0);
        assertTrue(titleAuthorComparator.compare(book2, book1) > 0);
        assertTrue(titleAuthorComparator.compare(book1, book3) < 0);

        assertTrue(titleAuthorComparator.compare(book1, book4) < 0);
        assertTrue(titleAuthorComparator.compare(book2, book4) < 0);
